...
VARIANT_ENUM_CAST(SteamServer::FriendFlags);
...
VARIANT_ENUM_CAST(SteamServer::ItemFlags);
VARIANT_ENUM_CAST(SteamServer::ItemPreviewType);
VARIANT_ENUM_CAST(SteamServer::ItemState);
...
VARIANT_ENUM_CAST(SteamServer::PersonaChange);
VARIANT_ENUM_CAST(SteamServer::PersonaState);

VARIANT_ENUM_CAST(SteamServer::RemoteStoragePlatform);
...
VARIANT_ENUM_CAST(SteamServer::UserRestriction);
